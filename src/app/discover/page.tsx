            ...
            <div className="flex flex-col max-w-screen-lg items-center gap-6 text-center z-10">
              ...
              <div className="text-base">
                <p className="text-dark-gray/50">
                  Contribute or fork on <a href="https://github.com/lucasygu/gumroad_educational_template_nextjs" target="_blank" rel="noopener noreferrer" className="underline hover:text-black inline-flex items-center gap-1 ml-1">
